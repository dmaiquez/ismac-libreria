...
public class ClienteServicioImplTestUnitaria {
    ...
    public void testUpdateExistente(){
        ...
        clienteActualizado.setCedula("1701234562");
        clienteActualizado.setNombre("Juan2");
        clienteActualizado.setApellido("Taipe2");
        clienteActualizado.setDireccion("Av. por ahi2");
        clienteActualizado.setTelefono("09876543212");
        clienteActualizado.setCorreo("jtaipe2@correo.com");
